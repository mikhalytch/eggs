...
func TestUnEmbedString(t *testing.T) {
	t.Run("string", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.String(emb))
	})
}
...
func TestUnEmbedBool(t *testing.T) {
	t.Run("bool", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Bool(emb))
	})
}
...
func TestUnEmbedInt(t *testing.T) {
	t.Run("int", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Int(emb))
	})
	t.Run("int64", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Int64(emb))
	})
	t.Run("int32", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Int32(emb))
	})
	t.Run("int16", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Int16(emb))
	})
	t.Run("int8", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Int8(emb))
	})
}
...
func TestUnEmbedUint(t *testing.T) {
	...
	t.Run("Uint16", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Uint16(emb))
	})
	...
	t.Run("Uint64", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Uint64(emb))
	})
	t.Run("Uintptr", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Uintptr(emb))
	})
	t.Run("Uint", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Uint(emb))
	})
}
...
func TestUnEmbedFloat(t *testing.T) {
	t.Run("Float32", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Float32(emb))
	})
	t.Run("Float64", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Float64(emb))
	})
}
...
func TestUnEmbedComplex(t *testing.T) {
	...
	t.Run("Complex128", func(t *testing.T) {
		...
		require.Equal(t, testVal, unembed.Complex128(emb))
	})
}
