...
func TestToMapWithValues(t *testing.T) {
	require.Equal(t, map[string]int{}, slices.ToMapWithValues(func(_ string) int { return 0 })([]string{}))
	require.Equal(t, map[string]int{"a": 0, "b": 0},
		slices.ToMapWithValues(func(_ string) int { return 0 })([]string{"a", "b"}))
...
func TestToMapWithKeys(t *testing.T) {
	require.Equal(t, map[string]int{}, slices.ToMapWithKeys(func(_ int) string { return "" })([]int{}))
	require.Equal(t, map[string]int{"a": 1},
		slices.ToMapWithKeys(func(_ int) string { return "a" })([]int{0, 1}))
	require.Equal(t, map[string]int{"a": 0, "b": 1},
